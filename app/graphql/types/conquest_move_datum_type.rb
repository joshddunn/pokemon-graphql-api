Types::ConquestMoveDatumType = GraphQL::ObjectType.define do
  ...
  field :effect, Types::ConquestMoveEffectType, "", property: :conquest_move_effect
  field :range, Types::ConquestMoveRangeType, "", property: :conquest_move_range
  field :displacement, Types::ConquestMoveDisplacementType, "", property: :conquest_move_displacement
