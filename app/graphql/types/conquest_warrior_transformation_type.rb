Types::ConquestWarriorTransformationType = GraphQL::ObjectType.define do
  ...
  field :transformedWarriorRank, Types::ConquestWarriorRankType, "", property: :conquest_warrior_rank
  field :isAutomatic, types.Boolean, "", property: :is_automatic
  field :requiredLink, types.Int, "", property: :required_link
  field :completedEpisode, Types::ConquestEpisodeType, "", property: :conquest_episode
  field :currentEpisode, Types::ConquestEpisodeType, "", property: :conquest_episode
  field :distantWarrior, Types::ConquestWarriorType, "", property: :conquest_warrior
