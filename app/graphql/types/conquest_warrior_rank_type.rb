Types::ConquestWarriorRankType = GraphQL::ObjectType.define do
  ...
  field :skill, Types::ConquestWarriorSkillType, '',
        property: :conquest_warrior_skill

  field :conquestMaxLinks, types[Types::ConquestMaxLinkType], '',
        property: :conquest_max_links
  field :conquestWarriorRankStatMaps,
        types[Types::ConquestWarriorRankStatMapType], '',
        property: :conquest_warrior_rank_stat_maps
  ...
  field :conquestTransformationPokemons,
        types[Types::ConquestTransformationPokemonType], '',
        property: :conquest_transformation_pokemons
